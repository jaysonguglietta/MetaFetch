...
- TV episode tagging: Choose TV Show, import files or a season folder, detect show/season/episode hints, search once for the series, review episode rows, apply shared choices, save all ready episodes, and inspect failures.
...
- TV filenames may omit show names, use unusual episode codes, include specials, or rely on folder context.
